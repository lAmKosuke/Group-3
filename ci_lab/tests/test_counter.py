...
class TestCounterEndpoints:
    ...
    # ===========================
    # Test: Counter name validation format
    # Author: Kosuke Carlson
    # Date: 2026-02-16
    # Description: Test counter name must be alphanumeric
    # ===========================
    def test_counter_name_alphanumeric(self, client):
        """It should only allow alphanumeric counter names"""
        # Valid name should work
        response = client.post('/counters/valid_name')
        assert response.status_code == HTTPStatus.CREATED
