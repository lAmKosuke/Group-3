...
# list of possible source file extensions
SOURCE_EXTENSIONS = {
    ".java", ".kt", ".c", ".cpp", ".h",
    ".py", ".js", ".ts", ".xml", ".gradle"
}
...
# helper function checks if passed-through file is a source file
...
lstTokens = ["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"]
